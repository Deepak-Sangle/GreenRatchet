/**
 * Water Withdrawal Analytics Service
 * Provides time-series data and forecasting for water withdrawal
...
/**
 * Fetch monthly water withdrawal with projections (cumulative totals)
 */
export async function getMonthlyWaterWithProjection(
  organizationId: string,
  monthsHistory = 12,
  monthsProjection = 6
): Promise<CumulativeWater[]> {
