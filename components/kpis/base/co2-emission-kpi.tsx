  ...
  return (
    <BaseKpiCard
      ...
      longDescription="Total CO₂ emissions represent the absolute greenhouse gas
              emissions generated by an organization’s cloud operations over a
              ...
              organization is reducing its overall environmental footprint
              through actions such as workload optimization, cleaner regions, or
