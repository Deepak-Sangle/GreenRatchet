...
function formatValue(value: number | undefined): string {
  ...
  if (value >= 1_000_000_000) {
    return `${(value / 1_000_000_000).toFixed(2)} GL`;
  } else if (value >= 1_000_000) {
    return `${(value / 1_000_000).toFixed(2)} ML`;
  } else if (value >= 1_000) {
    return `${(value / 1_000).toFixed(2)} kL`;
  }
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Cumulative water withdrawal over time with {projectedData.length}
              -month projection
            </p>
          </div>
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Area
                ...
                strokeWidth={2}
                fill="url(#waterHistoricalGradient)"
                connectNulls
              />
              <Area
                type="monotone"
                ...
                strokeWidth={2}
                strokeDasharray="5 5"
                fill="url(#waterProjectedGradient)"
                connectNulls
              />
            </AreaChart>
          </ResponsiveContainer>
