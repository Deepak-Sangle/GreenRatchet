...
interface Co2EmissionAnalyticsProps {
  analytics: DetailedKPIAnalytics;
  className?: string;
}

export function Co2EmissionAnalytics({
  analytics,
  className,
}: Co2EmissionAnalyticsProps) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Total greenhouse gas emissions from cloud operations
            </p>
          </div>
        </div>
        {latestResult && (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-primary/10 rounded-lg p-4">
              ...
              <p className="text-2xl font-semibold text-primary">
                ...
                <span className="text-sm font-normal">metric tons CO₂e</span>
              </p>
            </div>
      ...
      {regionalData.length > 0 && (
        <Card className="p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-heading font-semibold">Emissions by Region</h3>
          </div>
      ...
      {serviceData.length > 0 && (
        <Card className="p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-heading font-semibold">Emissions by Service</h3>
          </div>
          <ResponsiveContainer width="100%" height={400}>
            <BarChart
              data={serviceData}
